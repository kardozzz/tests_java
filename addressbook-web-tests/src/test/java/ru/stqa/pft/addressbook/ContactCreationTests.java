...
public class ContactCreationTests {
  ...
  public void testContactCreation() throws Exception {
    addNewContact();
    initContactInfo(new ContactData("Smith", "Testing", "TestingSmith22", "Florida", "222111222334455", "mister-smith@gmail.com", "10", "July", "1990"));
    inputCreateContact();
    gotoHomePageContact();
    logOutSystem();
  }
  ...
  private void initContactInfo(ContactData contactData) {
  ...
  private void inputCreateContact() {
